...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 04:42 AM
...
INSERT INTO `airports` (`airport_id`, `city_id`, `code`) VALUES
(28902, 19961, 'DXB'),
(28904, 19963, 'RUH');
...
INSERT INTO `tbl_airlines` (`al_id`, `air_line_name`) VALUES
(2, 'Saudi Airline'),
(3, 'Fly Dubai'),
(4, 'Emirates'),
(5, 'Cebu Pacific'),
...
--
-- Table structure for table `tbl_air_dest_charge`
--

CREATE TABLE `tbl_air_dest_charge` (
  `adc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `airport_id` int(11) NOT NULL,
  `adc_vendor` int(50) NOT NULL,
  `adc_description` varchar(150) NOT NULL,
  `adc_charge` double NOT NULL,
  `adc_currency` int(11) NOT NULL,
  `adc_uom` int(1) NOT NULL,
  `adc_min` double NOT NULL,
  `adc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_air_dest_charge`
--

INSERT INTO `tbl_air_dest_charge` (`adc_id`, `country_id`, `city_id`, `airport_id`, `adc_vendor`, `adc_description`, `adc_charge`, `adc_currency`, `adc_uom`, `adc_min`, `adc_validity`) VALUES
(4, 239, 19963, 28904, 7, 'Clearance Charge', 500, 3, 1, 0, '2023-12-31'),
(5, 239, 19963, 28904, 7, 'Bayan', 100, 3, 1, 0, '2023-12-31');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_air_frieght`
--

CREATE TABLE `tbl_air_frieght` (
  `af_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `airport_id` int(11) NOT NULL,
  `country_id_dest` int(11) NOT NULL,
  `city_id_dest` int(11) NOT NULL,
  `airport_id_dest` int(11) NOT NULL,
  `vn_id` int(11) NOT NULL,
  `al_id` int(11) NOT NULL,
  `af_description` varchar(150) NOT NULL,
  `af_min_weight` double NOT NULL,
  `af_max_weight` double NOT NULL,
  `af_charge` double NOT NULL,
  `af_currency` int(11) NOT NULL,
  `af_uom` int(1) NOT NULL,
  `af_validity` date NOT NULL,
  `other_charge` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_air_frieght`
--

INSERT INTO `tbl_air_frieght` (`af_id`, `country_id`, `city_id`, `airport_id`, `country_id_dest`, `city_id_dest`, `airport_id_dest`, `vn_id`, `al_id`, `af_description`, `af_min_weight`, `af_max_weight`, `af_charge`, `af_currency`, `af_uom`, `af_validity`, `other_charge`) VALUES
(5, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'Air Freight', 0, 44, 315, 1, 3, '2023-12-31', 0),
(6, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'Air Freight', 45, 99, 7, 1, 3, '2023-12-31', 0),
(7, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'Air Frieght', 100, 249, 5.75, 1, 3, '2023-12-31', 0),
(8, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'SCC', 0, 999999, 0.8, 1, 3, '2023-12-31', 1),
(13, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'XBC', 0, 200, 30, 1, 3, '0000-00-00', 1),
(14, 237, 19961, 28902, 239, 19963, 28904, 3, 2, 'XBC', 201, 999999, 0.15, 1, 3, '2023-12-31', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_air_orgin_charge`
--

CREATE TABLE `tbl_air_orgin_charge` (
  `aoc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `airport_id` int(11) NOT NULL,
  `aoc_vendor` varchar(50) NOT NULL,
  `aoc_description` varchar(150) NOT NULL,
  `aoc_charge` double NOT NULL,
  `aoc_currency` int(11) NOT NULL,
  `aoc_uom` int(1) NOT NULL,
  `aoc_min` double NOT NULL,
  `aoc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_air_orgin_charge`
--

INSERT INTO `tbl_air_orgin_charge` (`aoc_id`, `country_id`, `city_id`, `airport_id`, `aoc_vendor`, `aoc_description`, `aoc_charge`, `aoc_currency`, `aoc_uom`, `aoc_min`, `aoc_validity`) VALUES
(9, 237, 19961, 28902, '3', 'Label fee', 0.31, 1, 3, 31, '2023-12-31'),
(10, 237, 19961, 28902, '3', 'Bill of Entry', 125, 1, 1, 0, '2023-12-31'),
(13, 237, 19961, 28902, '3', 'DNATA handling', 0.18, 1, 2, 36, '2023-12-31'),
(14, 237, 19961, 28902, '3', 'Delivery Order', 114, 1, 1, 0, '2023-12-31'),
(15, 237, 19961, 28902, '3', 'Prime Handling charge', 500, 1, 1, 0, '2023-12-31');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_air_vendor`
--

CREATE TABLE `tbl_air_vendor` (
  `av_id` int(11) NOT NULL,
  `av_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_air_vendor`
--

INSERT INTO `tbl_air_vendor` (`av_id`, `av_name`) VALUES
(3, 'DNATA'),
(5, 'Red Line'),
(6, 'Choice Cargo'),
(7, 'Qarat Logistics');
...
INSERT INTO `tbl_container` (`cr_id`, `cr_name`) VALUES
(2, '20 Ft Std Container ');
...
INSERT INTO `tbl_countries` (`id`, `shortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
INSERT INTO `tbl_customer_info` (`c_id`, `c_name`, `c_company`, `country_id`, `state_id`, `city_id`, `c_address`, `u_phone`, `c_email`) VALUES
(23, 'Mohamed naveed', 'Mancode', 206, 0, 0, 'no19illawathuragampola', '+94765556575', 'webpack12@gmail.com');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_customer_odm`
--

CREATE TABLE `tbl_customer_odm` (
  `odm_id` int(11) NOT NULL,
  `odm_mtype` int(1) NOT NULL,
  `odm_orgin_country` int(11) NOT NULL,
  `odm_orgin_city` int(11) NOT NULL,
  `odm_orgin_a_s_b` int(11) NOT NULL,
  `odm_desti_country` int(11) NOT NULL,
  `odm_desti_city` int(11) NOT NULL,
  `odm_desti_a_s_b` int(11) NOT NULL,
  `c_id` int(11) NOT NULL,
  `tos` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_customer_odm`
--

INSERT INTO `tbl_customer_odm` (`odm_id`, `odm_mtype`, `odm_orgin_country`, `odm_orgin_city`, `odm_orgin_a_s_b`, `odm_desti_country`, `odm_desti_city`, `odm_desti_a_s_b`, `c_id`, `tos`) VALUES
(13, 1, 237, 19961, 28902, 239, 19963, 28904, 23, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_land_border`
--

CREATE TABLE `tbl_land_border` (
...
--
-- Dumping data for table `tbl_land_border`
--

INSERT INTO `tbl_land_border` (`lb_id`, `city_id`, `lb_name`) VALUES
(2, 19961, 'Silla'),
(3, 19963, 'Batha ');
...
--
-- Table structure for table `tbl_land_charge`
--

CREATE TABLE `tbl_land_charge` (
  ...
  `country_id_dest` int(11) NOT NULL,
  `city_id_dest` int(11) NOT NULL,
  `border_id_dest` int(11) NOT NULL,
  `gateway_c` int(2) NOT NULL,
  `vn_id` int(1) NOT NULL,
  `type_of_s` int(2) NOT NULL,
  `lc_desc` varchar(150) NOT NULL,
  `currency` int(2) NOT NULL,
  `rate` double NOT NULL,
  `min_weight` double NOT NULL,
  `max_weight` double NOT NULL,
  `min_cbm` double NOT NULL,
  `max_cbm` double NOT NULL,
  `oum` int(2) NOT NULL,
...
--
-- Dumping data for table `tbl_land_charge`
--

INSERT INTO `tbl_land_charge` (`lc_id`, `country_id`, `city_id`, `border_id`, `country_id_dest`, `city_id_dest`, `border_id_dest`, `gateway_c`, `vn_id`, `type_of_s`, `lc_desc`, `currency`, `rate`, `min_weight`, `max_weight`, `min_cbm`, `max_cbm`, `oum`, `transit`, `validity`) VALUES
(4, 237, 19961, 2, 239, 19963, 3, 0, 0, 1, 'Land Freight Charge', 1, 5120, 0, 15000, 0, 86, 7, 6, '2023-12-31'),
(5, 237, 19961, 0, 239, 19963, 0, 0, 0, 2, 'Land Freight', 1, 200, 0, 99, 0, 40, 1, 5, '2023-12-31'),
(6, 237, 19961, 0, 239, 19963, 0, 0, 0, 2, 'Land Freight Charge', 1, 2.4, 100, 499, 0, 40, 2, 5, '2023-12-31'),
(7, 237, 19961, 0, 239, 19963, 0, 0, 0, 2, 'Land Freight Charge', 1, 2.2, 500, 999, 0, 40, 2, 5, '2023-12-31');
...
CREATE TABLE `tbl_other_charges` (
  ...
  `oc_charge_name` varchar(150) NOT NULL,
  `oc_charge` double NOT NULL,
  `oc_currency` int(11) NOT NULL,
...
CREATE TABLE `tbl_package` (
  ...
  `p_qnty` double NOT NULL,
  `p_l` double NOT NULL,
  `p_w` double NOT NULL,
  `p_h` double NOT NULL,
  `p_volume` double NOT NULL,
...
INSERT INTO `tbl_package` (`p_id`, `p_qnty`, `p_l`, `p_w`, `p_h`, `p_volume`, `p_weight`, `c_id`) VALUES
(62, 10, 100, 100, 100, 100, 50, 18),
(63, 150, 150, 150, 150, 45, 10, 18),
(65, 10, 10, 10, 10, 0.2, 10, 19),
(66, 10, 10, 10, 10, 2, 100, 20),
(67, 10, 10, 10, 10, 2, 100, 21),
(68, 10, 10, 10, 10, 2, 100, 21),
(69, 10, 10, 10, 10, 0.2, 10, 22),
(70, 10, 10, 10, 10, 0.2, 10, 22),
(73, 10, 100, 100, 100, 20, 10, 23);
...
CREATE TABLE `tbl_quote` (
  `q_id` int(11) NOT NULL,
  `c_id` int(11) NOT NULL,
  `q_profit` double NOT NULL,
  `q_validity` date NOT NULL,
  `q_service` int(2) NOT NULL,
...
INSERT INTO `tbl_quote` (`q_id`, `c_id`, `q_profit`, `q_validity`, `q_service`, `q_status`, `u_id`) VALUES
(19, 23, 0, '0000-00-00', 1, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_road_charge`
--

CREATE TABLE `tbl_road_charge` (
...
--
-- Table structure for table `tbl_road_destination_charge`
--

CREATE TABLE `tbl_road_destination_charge` (
  `rdc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `border_id` int(11) NOT NULL,
  `rdc_tos` int(2) NOT NULL,
  `rdc_desc` varchar(150) NOT NULL,
  `rdc_charge` double NOT NULL,
  `currency` int(2) NOT NULL,
  `uom` int(2) NOT NULL,
  `rdc_min` double NOT NULL,
  `rdc_remark` varchar(150) NOT NULL,
  `rdc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_road_orgin_charge`
--

CREATE TABLE `tbl_road_orgin_charge` (
  `roc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `border_id` int(11) NOT NULL,
  `roc_tos` int(2) NOT NULL,
  `roc_desc` varchar(150) NOT NULL,
  `roc_charge` double NOT NULL,
  `currency` int(2) NOT NULL,
  `uom` int(2) NOT NULL,
  `roc_min` int(11) NOT NULL,
  `roc_remark` varchar(150) NOT NULL,
  `roc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_road_orgin_charge`
--

INSERT INTO `tbl_road_orgin_charge` (`roc_id`, `country_id`, `city_id`, `border_id`, `roc_tos`, `roc_desc`, `roc_charge`, `currency`, `uom`, `roc_min`, `roc_remark`, `roc_validity`) VALUES
(4, 237, 19961, 2, 1, 'Bill of entry charges', 105, 1, 1, 0, '', '2023-12-31'),
(5, 237, 19961, 2, 1, 'Customs Inspection', 170, 1, 1, 0, '', '2023-12-31'),
(6, 237, 19961, 2, 1, 'Border Charge via Batha Transit', 500, 1, 1, 0, '', '2023-12-31'),
(7, 237, 19961, 2, 2, 'Bill of entry charges', 105, 1, 1, 0, '', '2023-12-31'),
(8, 237, 19961, 2, 2, 'Customs Inspection', 170, 1, 1, 0, '', '2023-12-31'),
(9, 237, 19961, 2, 2, 'Claims Submission Charges', 90, 1, 1, 0, '', '2023-12-31');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_sea_charges`
--

CREATE TABLE `tbl_sea_charges` (
  `sc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `seaport_id` int(11) NOT NULL,
  `country_id_dest` int(11) NOT NULL,
  `city_id_dest` int(11) NOT NULL,
  `seaport_id_dest` int(11) NOT NULL,
  `vn_id` int(11) NOT NULL,
  `sc_tos` int(2) NOT NULL,
  `sc_toc` int(2) NOT NULL,
  `sc_desc` varchar(150) NOT NULL,
  `sc_min_weight` double NOT NULL,
  `sc_max_weight` double NOT NULL,
  `sc_min_cbm` double NOT NULL,
  `sc_max_cbm` double NOT NULL,
  `sc_charge_amount` double NOT NULL,
  `sc_currency` int(2) NOT NULL,
  `sc_uom` int(2) NOT NULL,
  `sc_transit_days` int(2) NOT NULL,
  `sc_remark` varchar(100) NOT NULL,
  `sc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_sea_charges`
--

INSERT INTO `tbl_sea_charges` (`sc_id`, `country_id`, `city_id`, `seaport_id`, `country_id_dest`, `city_id_dest`, `seaport_id_dest`, `vn_id`, `sc_tos`, `sc_toc`, `sc_desc`, `sc_min_weight`, `sc_max_weight`, `sc_min_cbm`, `sc_max_cbm`, `sc_charge_amount`, `sc_currency`, `sc_uom`, `sc_transit_days`, `sc_remark`, `sc_validity`) VALUES
(4, 237, 19961, 2, 239, 19963, 3, 4, 1, 2, 'Mohamed Naveed', 100, 150, 200, 250, 300, 1, 2, 0, '', '2023-11-22');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_sea_dest_charge`
--

CREATE TABLE `tbl_sea_dest_charge` (
  `sdc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `sp_id` int(11) NOT NULL,
  `sdc_vendor` varchar(100) NOT NULL,
  `sdc_tos` int(2) NOT NULL,
  `sdc_toc` int(2) NOT NULL,
  `sdc_desc` varchar(150) NOT NULL,
  `sdc_charge` double NOT NULL,
  `sdc_currency` int(2) NOT NULL,
  `sdc_uom` int(2) NOT NULL,
  `sdc_min` double NOT NULL,
  `sdc_remark` varchar(150) NOT NULL,
  `sdc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_sea_dest_charge`
--

INSERT INTO `tbl_sea_dest_charge` (`sdc_id`, `country_id`, `city_id`, `sp_id`, `sdc_vendor`, `sdc_tos`, `sdc_toc`, `sdc_desc`, `sdc_charge`, `sdc_currency`, `sdc_uom`, `sdc_min`, `sdc_remark`, `sdc_validity`) VALUES
(3, 239, 19963, 3, 'prime', 2, 0, 'Delivery Order', 525, 1, 4, 0, '', '2023-12-31'),
(4, 239, 19963, 3, 'prime', 2, 0, 'Customs Inspection', 170, 1, 1, 0, 'If Applicable ', '2023-12-31'),
(5, 239, 19963, 3, 'prime', 2, 0, 'Bill of entry charges', 125, 1, 4, 0, '', '2023-12-31'),
(6, 239, 19963, 3, 'prime', 2, 0, 'Co-Loader Charges', 125, 1, 5, 0, '', '2023-12-31'),
(7, 239, 19963, 3, 'prime', 2, 0, 'Transporation Charges', 125, 1, 1, 0, '', '2023-12-31'),
(9, 239, 19963, 3, 'prime', 1, 2, 'Delivery Orders', 525, 1, 4, 0, '', '2023-12-31'),
(10, 239, 19963, 3, 'prime', 1, 2, 'Terminal Handling 20ft', 770, 1, 6, 0, '', '2023-12-31'),
(11, 239, 19963, 3, 'prime', 1, 2, 'Bill of entry charges', 125, 1, 4, 0, '', '2023-12-31'),
(12, 239, 19963, 3, 'prime', 1, 2, 'DP world charges', 110, 1, 4, 0, '', '2023-12-31'),
(13, 239, 19963, 3, 'prime', 1, 2, 'Prime Handling charge', 500, 1, 4, 0, '', '2023-12-31');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_sea_orgin_charge`
--

CREATE TABLE `tbl_sea_orgin_charge` (
  `soc_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
  `sp_id` int(11) NOT NULL,
  `soc_vendor` varchar(100) NOT NULL,
  `soc_tos` int(2) NOT NULL,
  `soc_toc` int(2) NOT NULL,
  `soc_desc` varchar(150) NOT NULL,
  `soc_charge` double NOT NULL,
  `soc_currency` int(2) NOT NULL,
  `soc_uom` int(2) NOT NULL,
  `soc_min` double NOT NULL,
  `soc_remark` varchar(150) NOT NULL,
  `soc_validity` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_sea_orgin_charge`
--

INSERT INTO `tbl_sea_orgin_charge` (`soc_id`, `country_id`, `city_id`, `sp_id`, `soc_vendor`, `soc_tos`, `soc_toc`, `soc_desc`, `soc_charge`, `soc_currency`, `soc_uom`, `soc_min`, `soc_remark`, `soc_validity`) VALUES
(2, 237, 19961, 2, 'prime', 2, 2, 'Clearance Charge', 123, 1, 2, 123, 'asf', '2023-12-01');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_sea_port`
--

CREATE TABLE `tbl_sea_port` (
  `sp_id` int(11) NOT NULL,
  `city_id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_sea_port`
--

INSERT INTO `tbl_sea_port` (`sp_id`, `city_id`, `sp_name`) VALUES
(2, 19961, 'Jebel Ali Port'),
(3, 19963, 'Riyadh Dry Port');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_sea_vendors`
--

CREATE TABLE `tbl_sea_vendors` (
  `sv_id` int(11) NOT NULL,
  `sv_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_sea_vendors`
--

INSERT INTO `tbl_sea_vendors` (`sv_id`, `sv_name`) VALUES
(4, 'Westor'),
(5, 'COSCO'),
(6, 'OOCL'),
(7, 'QARAT');
...
INSERT INTO `tbl_users` (`u_id`, `u_name`, `u_pass`, `u_level`) VALUES
(4, 'admin', '123', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_warehouse_cat`
--

CREATE TABLE `tbl_warehouse_cat` (
  `wc_id` int(11) NOT NULL,
  `wc_name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_warehouse_cat`
--

INSERT INTO `tbl_warehouse_cat` (`wc_id`, `wc_name`) VALUES
(5, 'Inbound charges'),
(6, 'Handling in charges'),
(7, 'Storage charges'),
(8, 'Outbound charges'),
(10, 'Handling Out charges'),
(11, 'Dangerous goods handling'),
(12, 'Documentation charges'),
(13, 'Value added services');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_warehouse_data`
--

CREATE TABLE `tbl_warehouse_data` (
  `wd_id` int(11) NOT NULL,
  `wd_description` varchar(100) NOT NULL,
  `wd_uom` varchar(100) NOT NULL,
  `wd_rate` double NOT NULL,
  `wd_remarks` varchar(100) NOT NULL,
  `wd_validity` date NOT NULL,
  `wc_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_warehouse_data`
--

INSERT INTO `tbl_warehouse_data` (`wd_id`, `wd_description`, `wd_uom`, `wd_rate`, `wd_remarks`, `wd_validity`, `wc_id`) VALUES
(2, 'Un-stuffing charges', '20 Container', 150, 'If applicable', '2024-12-31', 5),
(3, '', '40 Container', 350, 'If applicable', '2024-12-31', 5),
(4, '', 'Per CBM', 10, 'Minimum AED 100 / shipment', '2024-12-31', 5),
(5, '', 'Per CBM', 10, 'Minimum AED 100 / shipment', '2024-12-31', 6),
(6, 'Storage charges', 'Per CBM / day', 1.5, 'Minimum AED 500 / month', '2024-12-31', 7),
(7, 'Warehouse management', 'Per month', 500, '', '2024-12-31', 7),
(8, 'Stuffing charges', '20 Container', 150, 'If applicable', '2024-12-31', 8),
(9, '', '40 Container', 350, 'If applicable', '2024-12-31', 8),
(10, '', 'Per CBM', 10, 'Minimum AED 100 / shipment', '2024-12-31', 8),
(11, '', 'Per CBM', 10, 'Minimum AED 100 / shipment', '2024-12-31', 10),
(12, '', 'Per shipment', 250, '', '2024-12-31', 11),
(13, 'Document charges', 'Per shipment', 250, '', '2024-12-31', 12),
(14, 'Certificate of origin', 'Per shipment', 175, '', '2024-12-31', 12),
(15, 'Dangerous goods approval', 'Per shipment', 300, '', '2024-12-31', 12),
(16, 'Piece pick charges', 'Per piece', 1.25, 'Minimum AED 40 / shipment', '2024-12-31', 13),
(17, 'Carton pick charges', 'Per carton', 4, 'Minimum AED 40 / shipment', '2024-12-31', 13),
(18, 'Pallet pick charges', 'Per pallet', 20, 'Minimum AED 50 / shipment', '2024-12-31', 13),
(19, 'Palletization charges', 'Per pallet', 70, '', '2024-12-31', 13),
(20, 'Supply of boxes', 'Per box', 20, '', '2024-12-31', 13),
(21, 'Serial no. / IMEI scanning', 'Per piece', 0.15, 'Minimum AED 25 / shipment', '2024-12-31', 13);
...
--
-- Indexes for table `tbl_air_dest_charge`
--
ALTER TABLE `tbl_air_dest_charge`
  ADD PRIMARY KEY (`adc_id`);

--
-- Indexes for table `tbl_air_frieght`
--
ALTER TABLE `tbl_air_frieght`
  ADD PRIMARY KEY (`af_id`);

--
-- Indexes for table `tbl_air_orgin_charge`
--
ALTER TABLE `tbl_air_orgin_charge`
  ADD PRIMARY KEY (`aoc_id`);

--
-- Indexes for table `tbl_air_vendor`
--
ALTER TABLE `tbl_air_vendor`
...
--
-- Indexes for table `tbl_customer_odm`
--
ALTER TABLE `tbl_customer_odm`
  ADD PRIMARY KEY (`odm_id`);

--
-- Indexes for table `tbl_land_border`
--
ALTER TABLE `tbl_land_border`
  ADD PRIMARY KEY (`lb_id`);

--
-- Indexes for table `tbl_land_charge`
--
ALTER TABLE `tbl_land_charge`
...
--
-- Indexes for table `tbl_road_charge`
--
ALTER TABLE `tbl_road_charge`
  ADD PRIMARY KEY (`rc_id`);

--
-- Indexes for table `tbl_road_destination_charge`
--
ALTER TABLE `tbl_road_destination_charge`
  ADD PRIMARY KEY (`rdc_id`);

--
-- Indexes for table `tbl_road_orgin_charge`
--
ALTER TABLE `tbl_road_orgin_charge`
  ADD PRIMARY KEY (`roc_id`);

--
-- Indexes for table `tbl_sea_charges`
--
ALTER TABLE `tbl_sea_charges`
  ADD PRIMARY KEY (`sc_id`);

--
-- Indexes for table `tbl_sea_dest_charge`
--
ALTER TABLE `tbl_sea_dest_charge`
  ADD PRIMARY KEY (`sdc_id`);

--
-- Indexes for table `tbl_sea_orgin_charge`
--
ALTER TABLE `tbl_sea_orgin_charge`
  ADD PRIMARY KEY (`soc_id`);

--
-- Indexes for table `tbl_sea_port`
--
ALTER TABLE `tbl_sea_port`
  ADD PRIMARY KEY (`sp_id`);

--
-- Indexes for table `tbl_sea_vendors`
--
ALTER TABLE `tbl_sea_vendors`
...
--
-- Indexes for table `tbl_warehouse_cat`
--
ALTER TABLE `tbl_warehouse_cat`
  ADD PRIMARY KEY (`wc_id`);

--
-- Indexes for table `tbl_warehouse_data`
--
ALTER TABLE `tbl_warehouse_data`
...
--
ALTER TABLE `airports`
  MODIFY `airport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28905;

--
-- AUTO_INCREMENT for table `cities`
--
ALTER TABLE `cities`
  MODIFY `city_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19964;
...
--
ALTER TABLE `tbl_airlines`
  MODIFY `al_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_air_dest_charge`
--
ALTER TABLE `tbl_air_dest_charge`
  MODIFY `adc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_air_frieght`
--
ALTER TABLE `tbl_air_frieght`
  MODIFY `af_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_air_orgin_charge`
--
ALTER TABLE `tbl_air_orgin_charge`
  MODIFY `aoc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_air_vendor`
--
ALTER TABLE `tbl_air_vendor`
...
--
-- AUTO_INCREMENT for table `tbl_customer_odm`
--
ALTER TABLE `tbl_customer_odm`
  MODIFY `odm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_land_border`
--
ALTER TABLE `tbl_land_border`
  MODIFY `lb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_land_charge`
--
ALTER TABLE `tbl_land_charge`
...
--
-- AUTO_INCREMENT for table `tbl_road_charge`
--
ALTER TABLE `tbl_road_charge`
  MODIFY `rc_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_road_destination_charge`
--
ALTER TABLE `tbl_road_destination_charge`
  MODIFY `rdc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_road_orgin_charge`
--
ALTER TABLE `tbl_road_orgin_charge`
  MODIFY `roc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_sea_charges`
--
ALTER TABLE `tbl_sea_charges`
  MODIFY `sc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_sea_dest_charge`
--
ALTER TABLE `tbl_sea_dest_charge`
  MODIFY `sdc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_sea_orgin_charge`
--
ALTER TABLE `tbl_sea_orgin_charge`
  MODIFY `soc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_sea_port`
--
ALTER TABLE `tbl_sea_port`
  MODIFY `sp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_sea_vendors`
--
ALTER TABLE `tbl_sea_vendors`
...
--
-- AUTO_INCREMENT for table `tbl_warehouse_cat`
--
ALTER TABLE `tbl_warehouse_cat`
  MODIFY `wc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_warehouse_data`
--
ALTER TABLE `tbl_warehouse_data`
  MODIFY `wd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
COMMIT;
