...
$sqlAdd = "INSERT INTO tbl_customer_odm
            ...
            VALUES
            ('$m_type',
              '$orgin_country','$orgin_city','$orgin_border',
              '$destination_country','$destination_city','$destination_border',
              '$cus_id','$tos')";
$rsAdd = $conn->query($sqlAdd);
