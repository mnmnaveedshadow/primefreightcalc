...
<?php
$a_oc_id = $_REQUEST['a_oc_id'];
$sql = "SELECT * FROM `tbl_air_orgin_charge` WHERE aoc_id='$a_oc_id'";
...
if($rs->num_rows >0){
  $row = $rs->fetch_assoc();
   ...
   ?>
<input type="hidden" id="aoc_id" name="" value="<?= $a_oc_id ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="desc_edit"  placeholder="Description" name="description" value="<?= $row['aoc_description'] ?>" required>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="">Aed</label>
    <input type="number" class="form-control" id="aed_edit" placeholder="Aed" name="aed" value="<?= $row['aoc_charge'] ?>" required>
</div>
<div class="form-group">
    <label for="">Min Aed</label>
    <input type="number" class="form-control" id="min_aed_edit" placeholder="Min Aed" name="min_aed" value="<?= $row['aoc_min'] ?>" required>
</div>
<div class="form-group">
    <label for="">VALIDITY</label>
    <input type="date" class="form-control" id="validity_edit" placeholder="VALIDITY" name="validity" value="<?= $row['aoc_validity'] ?>" required>
</div>
<button type="button" class="btn btn-primary btn-me2" onclick="updateOcharge()" name="button">Update</button>
<br><br>
